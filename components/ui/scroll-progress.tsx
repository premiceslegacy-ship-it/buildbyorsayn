    ...
    >
      ...
      {size && (
        <motion.div
          ...
          className={cn(
            "absolute bottom-0 left-1/2 -translate-x-1/2 overflow-hidden border border-[#e8d5b0]/15 bg-[#0e0e0f]/80 shadow-lg backdrop-blur-md",
            squircle
          )}
          initial={false}
          animate={{
                    ...
                    <li key={s.id}>
                      <button
                        ...
                        className={cn(
                          ...
                          isActive
                            ? "text-[#f0ede8]"
                            : "text-[#f0ede8]/55 hover:text-[#f0ede8]/80"
                        )}
                      >
                        {isActive && (
                          <motion.span
                            ...
                            className={cn(
                              "absolute inset-0 rounded-[14px] bg-[#e8d5b0]/10",
                              squircle
                            )}
                            transition={
                        ...
                        <motion.span
                          className={cn(
                            ...
                            isActive ? "bg-[#e8d5b0]" : "bg-[#f0ede8]/30"
                          )}
                          initial={
                            reduceMotion
                              ? undefined
                  ...
                  <AnimatePresence initial={false}>
                    {label && (
                      <motion.span
                        ...
                        className="absolute inset-y-0 left-0 flex items-center whitespace-nowrap text-sm font-medium leading-none text-[#f0ede8]"
                        initial={
                          reduceMotion
                            ? { opacity: 0 }
